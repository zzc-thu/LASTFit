! This subroutine calculate the derivative of the first CV1 with respect to 
! the shockH, shockHdxi, shockHdzeta, shockV
SUBROUTINE Calculate_UshkDeri_CV1_B(u_inf, v_inf, w_inf, p_inf, rho_inf, &
...
! Output variables: CV_1,CV_2,CV_3,CV_4,CV_5
  ...
  REAL(kind=8) :: delta_infb, masn2infb
...
&   tempb2
  delta_infb = mach_ref**2*2.d0*delta_inf*masn2infb
...
&   wallnormalx*heta*xdxib
  cv_1b = 0.0_8
END SUBROUTINE Calculate_UshkDeri_CV1_B