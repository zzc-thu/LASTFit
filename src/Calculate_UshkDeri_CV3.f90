SUBROUTINE Calculate_UshkDeri_CV3_B(u_inf, v_inf, w_inf, rho_inf, &
...
! Output variables: CV_1,CV_2,CV_3,CV_4,CV_5
  ...
  REAL(kind=8) :: v, rho, mach_ref, gamma
  REAL(kind=8) :: vb, rhob
...
&   wallnormalx*heta*xdxib
  cv_3b = 0.0_8
END SUBROUTINE Calculate_UshkDeri_CV3_B