! This subroutine calculate the derivative of the first CV2 with respect to 
! the shockH, shockHdxi, shockHdzeta, shockV
SUBROUTINE Calculate_UshkDeri_CV2_B(u_inf, v_inf, w_inf, rho_inf, &
...
! Output variables: CV_1,CV_2,CV_3,CV_4,CV_5
  ...
  REAL(kind=8) :: u, rho, mach_ref, gamma
  REAL(kind=8) :: ub, rhob
...
&   tempb2
  ...
  shocknormalzb = w_inf*delta_infb + wallnormalz*tempb2
...
&   wallnormalx*heta*xdxib
  cv_2b = 0.0_8
END SUBROUTINE Calculate_UshkDeri_CV2_B